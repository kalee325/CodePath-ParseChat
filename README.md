...
<img src='https://i.imgur.com/YeHO1aC.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
The originally parse server given by CodePath was crashed, so I could do user login. Later on, I figured out that I could create my own parse server. Therefore, I solved my problem
